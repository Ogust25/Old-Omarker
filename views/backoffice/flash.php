<div class="flex flex-wrap justify-evenly">
    <!-- Contenu a afficher -->
        <div class="w-10% mx-10 my-5 hover:text-slate-500 hover:border-slate-500 font-bebas text-2xl flex justify-center items-center border rounded-md border-black cursor-pointer">
            <p>Ajouter</p>
        </div>
